pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/bressmj/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('bressmj-225')   // <---- Change this to match your kubernetes cluster credentials
    }
